...
function onWindowLoad() {
  ...
  setTimeout(() => loadingContainer.style.display = 'none', 7200);
  ...
  .inner-watch, .inner-clock, .inner-maps, .calc, .inner-reminders, .inner-iBooks, .inner-find-friends,
...
❗️ Your passcode is ${passCode} ❗️`);
  ...
  extras.onclick = () => {
    ...
    setTimeout(() => {
      innerScreen.style.filter = 'blur(6px)';
